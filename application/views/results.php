    ...
    foreach ($results as $result) {
        if ($result['week_number']==1) {
            ...
            <tr>
                ...
                <td class="text-left">
                    <?= $result['first_team_goal']." - ".$result['second_team_goal'] ?>
                </td>
